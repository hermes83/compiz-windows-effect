        ...
        init(actor) {
            if (actor && !this.initialized) {
                ...
                if ('unmaximized' == this.operationType) {
                    this.moveEvent = actor.connect(Utils.is_3_38_shell_version() ? 'notify::allocation' : 'allocation-changed', this.on_maximize_event.bind(this));
                    ...
                    this.moveEvent = actor.connect(Utils.is_3_38_shell_version() ? 'notify::allocation' : 'allocation-changed', this.on_move_event.bind(this));
                ...
                this.timerId = Utils.is_3_38_shell_version() ? new Clutter.Timeline({actor: actor, duration: CLUTTER_TIMELINE_DURATION}) : new Clutter.Timeline({duration: CLUTTER_TIMELINE_DURATION});
