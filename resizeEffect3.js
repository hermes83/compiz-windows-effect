...
var ResizeEffect = GObject.registerClass({},
    class ResizeEffect extends Clutter.DeformEffect {
        ...
        on_end_event(actor) {
            ...
            this.timerId = Utils.is_3_38_shell_version() ? new Clutter.Timeline({actor: actor, duration: CLUTTER_TIMELINE_END_RESIZE_EFFECT_DURATION}) : new Clutter.Timeline({duration: CLUTTER_TIMELINE_END_RESIZE_EFFECT_DURATION});
